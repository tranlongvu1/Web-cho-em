...
function startCameraAnimation() {
    ...
    function animatePath() {
        ...
        if (progress < duration1) {
            ...
            const reopenEnd = document.getElementById('reopen-end');
            if (endPanel) endPanel.classList.add('show');
            if (reopenEnd) reopenEnd.classList.add('show');
            return;
        }
...
if (closeEnd) {
    closeEnd.addEventListener('click', () => {
        if (endPanel) endPanel.classList.remove('show');
        if (reopenEnd) reopenEnd.classList.add('show');
    });
}
if (reopenEnd) {
    reopenEnd.addEventListener('click', () => {
        if (endPanel) endPanel.classList.add('show');
        reopenEnd.classList.remove('show');
    });
}
...
document.getElementById("exit-page6").addEventListener("click", () => {
